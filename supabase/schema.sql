...
-- Stores temporary anonymous user sessions
...
-- Anonymous sessions: Everyone can read and insert their own
...
-- Posts: Everyone can read and create
...
-- Comments: Everyone can read and create
...
-- Daily polls: Everyone can read
CREATE POLICY "Polls are viewable by everyone"
  ON public.daily_polls FOR SELECT
  USING (true);

-- Poll votes: Everyone can read and vote
...
-- User reactions: Everyone can read and react
...
-- Insert a sample daily poll (optional - for testing)
